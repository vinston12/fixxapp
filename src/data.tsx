...
export const mockSpecialists: SpecialistCard[] = [
  ...
  { id: '5', name: 'Krzysztof Krawczyk', category: 'hydraulik', image: 'https://i.pravatar.cc/400?img=15', rating: 4.6, reviewCount: 67, priceFrom: 100, availabilityLabel: 'Dostępny jutro', verified: true, city: 'Kraków' },
  { id: '6', name: 'Adam Małysz', category: 'hydraulik', image: 'https://i.pravatar.cc/400?img=16', rating: 4.9, reviewCount: 312, priceFrom: 160, availabilityLabel: 'Dostępny od dziś', verified: true, city: 'Kraków' },
  // Złota rączka
  ...
  { id: '8', name: 'Andrzej Duda', category: 'zlota-raczka', image: 'https://i.pravatar.cc/400?img=18', rating: 4.5, reviewCount: 45, priceFrom: 90, availabilityLabel: 'Dostępny jutro', verified: true, city: 'Kraków' },
  { id: '9', name: 'Kamil Stoch', category: 'zlota-raczka', image: 'https://i.pravatar.cc/400?img=19', rating: 4.7, reviewCount: 110, priceFrom: 100, availabilityLabel: 'Dostępny w tym tygodniu', verified: true, city: 'Kraków' },
];
