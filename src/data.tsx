...
export const mockSpecialists: SpecialistCard[] = [
  // Elektrycy
  { id: '1', name: 'Konrad', category: 'elektryk', image: 'https://i.ibb.co/RGSq8qJ8/Gemini-Generated-Image-q7mu05q7mu05q7mu.png', rating: 4.9, reviewCount: 124, priceFrom: 150, availabilityLabel: 'Dostępny jutro', verified: true, city: 'Kraków', phone: '537 034 780' },
  { id: '2', name: 'Andrzej', category: 'elektryk', image: 'https://i.ibb.co/GQ1qkQDk/Gemini-Generated-Image-go34uggo34uggo34.png', rating: 4.7, reviewCount: 89, priceFrom: 120, availabilityLabel: 'Dostępny od dziś', verified: true, city: 'Kraków', phone: '509 446 492' },
  { id: '3', name: 'Grzegorz', category: 'elektryk', image: 'https://i.ibb.co/DPqMhqJF/Gemini-Generated-Image-e0lt3be0lt3be0lt.png', rating: 5.0, reviewCount: 200, priceFrom: 180, availabilityLabel: 'Dostępny w tym tygodniu', verified: true, city: 'Kraków', phone: '721 156 843' },
  // Naprawa AGD
